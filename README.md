...
***pathviz*** aims to serve as a framework for concrete implementations and intuitive visualizations of classic path planning algorithms.

## About

The algorithms that have been / will be implemented here have been covered thoroughly in literature, as well as in various courses whose material is freely available online. In particular, ***Principles of Robot Motion (Choset, et al)*** and ***Computational Geometry (de Berg, et al)*** are my main reference texts.
...
- ROS Melodic
- rviz
- [graphlib](https://github.com/tedklin/back-to-basics/tree/master/cpp/graphlib) (A separate library I wrote for more general fundamental graph theory)
