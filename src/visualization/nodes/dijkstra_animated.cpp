...
int main(int argc, char** argv) {
  ros::init(argc, argv, "dijkstra_animated");
  ros::NodeHandle n;
  ...
  // First set up static visibility graph on which we run Dijkstra's.
  ...
  // Set up and run Dijkstra's animation.
  ...
  auto path = graph_search::dijkstra(&vis_graph, start_vertex, goal_vertex,
                                     &animation_manager);
